...
function Reserva({ reserva, deleteReservas }) {
    ...
    return (
        <>
            <div className="col-12 border rounded-3 shadow-sm d-flex align-items-center justify-content-center text-center mt-3 ">
                <div className="col-3">
                    <img src={reserva.recintoImagen} alt={reserva.recintoImagen} className="w-100 rounded-start-2 shadow-sm " />
                </div>
